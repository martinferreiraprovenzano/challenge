...
- Si querés, puedo:
  - migrar a JPA + H2 y adaptar tests, o
  - añadir validaciones (no nulos, amount >= 0) y detección de ciclos en la jerarquía parent/child.

---

Archivo generado automáticamente por el equipo de desarrollo (actualizable).